...
class Transformacje:
    def __init__(self, model: str = 'wgs80'):
        if model == "wgs84":
            ...
            print('Uwaga!\n Przy elipsoidzie Krassowskiego zamiana na układy PL-2000 i PL-92 \nnie da poprawnych wyników')
        else:
    ...
    def phi_lam_XYZ(self, phi, lam, h, output = 'dec_degree'):
        '''
        Funkcja zamienia współrzędne geodezyjne na współrzędne ortokartezjańskie
